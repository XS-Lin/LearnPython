...
from object_detection_2d_geometric_ops import Resize, RandomFlip, RandomRotate
from object_detection_2d_patch_sampling_ops import PatchCoordinateGenerator, RandomPatch
